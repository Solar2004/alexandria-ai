---
description: Lista los subagentes disponibles por categoria y encuentra el adecuado para una tarea
...
3. Si no doy tarea: lista las categorías y 3 ejemplos de cada una.

Elige y spawnea con la tool Task (agent_type + description autocontenida). 選賢與能 — el agente correcto para cada trabajo.
